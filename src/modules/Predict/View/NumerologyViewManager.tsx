    ...
    >
      ...
      >
        ...
        style={{
          ...
          <p className="title-font number-glory font-bold text-white
        ...
        <div className="rounded-2xl col-span-6 h-full w-full grid border-slate-400  bg-opacity-10 text-white text-left"
            ...
            <div className="px-5 py-3  self-center text-[18px] uppercase  font-bold"
              ...
              <p className="mb-8 ml-6 whitespace-pre-wrap leading-relaxed text-white">{listPredict.data?.twelve_numerology.summary}
               </p>
        </div>
        {/* ===================== */}
