  ...
  return (
    ...
    >
        ...
        {props.cart.map((item: any, index: number) => {
          return (
            ...
            >
              ...
              <div className="flex flex-row mt-10 z-10">
      ...
      <div className="flex flex-col h-[15%] justify-center items-center px-5">
        ...
        border-ErrorContainerLight/30 text-md font-semibold rounded-lg  px-4 py-2"
          >
            Xoá giỏ hàng
          </button>
          <button
            ...
            className="bg-PrimaryContainerLight text-md font-semibold  disabled:bg-gray-50/5 disabled:border-gray-50/40 disabled:text-black/20 border-PrimaryContainerLight/40 rounded-lg text-OnPrimaryContainerLight px-4 py-2"
          >
            Đặt hàng
          </button>
        </div>
